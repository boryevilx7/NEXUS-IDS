...
// We do not have next/image, so we'll use a normal img tag.
      ...
      {googleLogin && (
        <>
          ...
          >
            ...
            >
              <span className='flex items-center justify-center w-full h-full gap-3 text-neutral-800 dark:text-neutral-200'>
                <Image
            ...
            <section key={field.label} className='flex flex-col gap-2'>
              <BoxReveal boxColor='var(--skeleton)' duration={0.3}>
                <Label htmlFor={field.label}>
                  <span className="text-neutral-800 dark:text-neutral-200">{field.label}</span> <span className='text-red-500'>*</span>
                </Label>
              </BoxReveal>
              ...
              >
                <section className='relative'>
                  ...
                  {field.type === 'password' && (
                    ...
                    >
                      {visible ? (
                        <Eye className='h-5 w-5 text-neutral-800 dark:text-neutral-200' />
                      ) : (
                        <EyeOff className='h-5 w-5 text-neutral-800 dark:text-neutral-200' />
                      )}
                    </button>
                  )}
                </section>
